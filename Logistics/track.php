...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  if (isset($_POST['search'])) {
    ...
    $query = "SELECT * FROM Log WHERE Manvaasam_ID ='$NewId'";
...
?>
          ...
          <body>
              ...
              <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                  <ul class="nav navbar-nav navbar-right" style="margin-top: 1%;margin-left: 20%;padding-left: 5%;padding: auto;">
                    <li>
                      <h3 style="margin-top:22px;margin-bottom: 20%; padding-top:10%; "></h3>
                    </li>
            ...
            <center>
              ...
              <table id="customers" class="table table--dark table-hover" style="width:50%; height:100px;font-size:20px;">
                <tr class="table-dark">
...
<?php
        ...
        echo "<h1 style='color: red; height: 100vh; display: flex; justify-content: center; align-items: center; '> No Tracker ID is founded </h1>";
      }
    } else {
      echo "Sqli Database Connection Refused";
    }
  } else {
    // header("Location: yindex.php");
    echo "Unknown Parameter/Search Value";
  }
} else {
  echo "Post Request Only Acceptable";
}
