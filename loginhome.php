...
<!DOCTYPE html>
  ...
  <body>
    ...
    <div class="row">
      <div class="column 1">
        <a href="coursematerials.php" target="_self"><img src="./image/login/img1.png" alt="#"></a>
        <h3>Course materials</h3>
      </div>

      <div class="column 2">
        <a href="recordings.html" target="_self"><img src="./image/login/img2.png" alt="Responsive image"></a>
        <h3>Course recordings</h3>
      </div>
      <div class="column 3">
        <a href="Certificate.php" target="_self"><img src="./image/login/img3.png" alt="#"></a>
        <h3>Certificate</h3>
      </div>
    </div>
  </body>
