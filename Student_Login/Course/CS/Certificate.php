            ...
            <div class="row wow animate__fadeIn animate__slower" style="margin-top:1%;background-color:#90d156;margin-bottom:8%;border-radius: 60px 5px;box-shadow: 0 4px 8px 0 rgba(68, 67, 67, 0.2), 0 6px 20px 0 rgba(80, 79, 79, 0.19);">
                ...
                <div class="row container">
                 ...
                 <h1 style="margin-left: 30%;"><b>COURSE DETAILS </b></h1>
                    ...
                    <h3 style="margin-top:1% ; margin-bottom:10% ;margin-left:1%;:10%text-align-last: center;"><b>Course Duration:</b>14.08.2021 - 05.09.2021 </h3> </div>
                  ...
                  <center>
                   <div class="container-fluid">  
                        ...
                        <img src="certificate/<?php echo $_SESSION['name']?>.jpg alt="No Certificate Attached" width="800px" height="570px"/><br><br>
			
                        <a href='certificate/<?php echo $_SESSION['name']?>.pdf'target="_blank" download><button type="button" class="btn btn-success"style=" padding: 5px;margin-bottom:10px">CERTIFICATE DOWNLOAD</button><span></span></a> 
