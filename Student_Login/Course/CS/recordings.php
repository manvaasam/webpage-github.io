  ...
  <body >
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
     ...
     <div class="row">
        ...
        <div class="col-sm-4"><iframe  style="border-radius:30px 10px;"width="400" height="300" src="video/day_1.mp4" title="YouTube video player" autoplay="0" frameborder="0" allow="accelerometer;  clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
        <div class="col-sm-4"><iframe  style="border-radius:30px 10px;"width="400" height="300" src="video/day_2.mp4" title="YouTube video player" autoplay="0" frameborder="0" allow="accelerometer;  clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
       <div class="col-sm-4"><iframe  style="border-radius:30px 10px;"width="400" height="300" src="video/day_3.mp4" title="YouTube video player" autoplay="0" frameborder="0" allow="accelerometer;  clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>-
     </div>
        <div class="row" style="margin-top:3%">
        <div class="col-sm-4"><h3>DAY 4</h3></div>
        <div class="col-sm-4"><h3>DAY 5</h3></div>
        <div class="col-sm-4"><h3>DAY 6</h3></div>
        <div class="col-sm-4"><iframe  style="border-radius:30px 10px;"width="400" height="300" src="video/day_4.mp4" title="YouTube video player" autoplay="0"  frameborder="0" allow="accelerometer;  clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
        <div class="col-sm-4"><iframe  style="border-radius:30px 10px;"width="400" height="300" src="video/day_5.mp4" title="YouTube video player" autoplay="0" frameborder="0" allow="accelerometer;  clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
        <div class="col-sm-4"><iframe  style="border-radius:30px 10px;"width="400" height="300" src="video/day_6.mp4" title="YouTube video player" autoplay="0" frameborder="0" allow="accelerometer;  clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
     </div>
    <div class="row" style="margin-top:3%">
        <div class="col-sm-4"><h3>DAY 7</h3></div>
        <div class="col-sm-4"><h3>DAY 8</h3></div>
        <div class="col-sm-4"><h3>DAY 9</h3></div>
        <div class="col-sm-4"><iframe  style="border-radius:30px 10px;"width="400" height="300" src="video/day_7.mp4" title="YouTube video player" autoplay="0" frameborder="0" allow="accelerometer;  clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
        <div class="col-sm-4"><iframe  style="border-radius:30px 10px;"width="400" height="300" src="video/day_8.mp4" title="YouTube video player" autoplay="0" frameborder="0" allow="accelerometer;  clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
        <div class="col-sm-4"><iframe  style="border-radius:30px 10px;"width="400" height="300" src="video/day_9.mp4" title="YouTube video player" autoplay="0" frameborder="0" allow="accelerometer;  clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
     </div> 
    ...
    <div class="row" style="margin-top:3%">
       ...
       <!-- <div class="col-sm-4"><h3>DAY 11</h3></div>
        ...
        <div class="col-sm-4"><iframe  style="border-radius:30px 10px;"width="400" height="300" src="video/day_10" title="YouTube video player" autoplay="0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
