            ...
            <center>
             <h2 class="wow animate__flipInX"style="margin-left:1%"><b>MATERIALS</b></h2>
                 <div class="container-fluid"> 
                        ...
                        <embed src="./image/cert/sample.pdf" width="800px" height="570px"/>
                        <div style="margin-bottom: 2%;margin-top: 2%; " >
                        <center>
                        <a href="./image/cert/sample.pdf" target="_blank" download><button type="button" class="btn btn-success">DOWNLOAD</button><span></span></a>
                        </div>
                        </center>
</body>
