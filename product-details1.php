...
<body>
  ...
  <div class="small-container single-product">
    <div class="row">
      <div class="col-2">
        <img src="image/products/Egg incubator11.jpeg" width="100%" id="ProductImg" />

        <div class="small-img-row">
          <div class="small-img-col">
            <img src="image/products/Egg incubator11.jpeg" class="small-img" />
          </div>
          <div class="small-img-col">
            <img src="image/products/Egg incubator3.jpeg" class="small-img" />
          </div>
          <div class="small-img-col">
            <img src="image/products/Egg incubator.jpeg" class="small-img" />
          </div>
          <div class="small-img-col">
            <img src="image/products/Egg incubator2.jpeg" class="small-img" />
          </div>

        </div>
      </div>
      <div class="col-2">
        <p>Product / Egg incubator</p>
        <h2 id="ProductName">Manvaasam Egg incubatort</h2>
        <h4 id="orderprice">Rs. 3999.00 + Shipping fee*</h4>
